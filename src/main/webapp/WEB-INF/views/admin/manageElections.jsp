                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form action="${pageContext.request.contextPath}/admin/delete-election" method="post" style="display:inline;">
                                                        <input type="hidden" name="electionId" value="${election.electionId}">
                                                        <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this election? This action cannot be undone.')">
                                                            Delete
                                                        </button>
                                                    </form>
                                                </div>
